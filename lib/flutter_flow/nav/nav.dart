...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: SchoolsWidget.routeName,
          path: SchoolsWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'Schools')
              : SchoolsWidget(),
        ),
        FFRoute(
          name: GradePageWidget.routeName,
          path: GradePageWidget.routePath,
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: GradePageWidget(
        ...
        FFRoute(
          name: StudentsGradeWidget.routeName,
          path: StudentsGradeWidget.routePath,
          builder: (context, params) => NavBarPage(
            initialPage: '',
            page: StudentsGradeWidget(
              schoolref: params.getParam(
                'schoolref',
                ParamType.DocumentReference,
                isList: false,
              ...
              gradedoc: params.getParam(
                'gradedoc',
                ParamType.DocumentReference,
                isList: false,
                collectionNamePath: ['grade'],
              ),
            ),
          ),
        ),
